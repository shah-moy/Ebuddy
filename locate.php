...
<div style="height:500px; width:100%; ">
    ...
    <script>
        ...
        function saveData(lat,lng) {
            var shop_name=document.getElementById('manual_shop_name').value;
            var hour=document.getElementById('manual_hour').value;
            var description = document.getElementById('manual_description').value;
            var url = 'locations_model.php?add_location&shop_name&hour&description =' +'&shop_name=' + shop_name + '&hour=' + hour + '&description=' + description + '&lat=' + lat + '&lng=' + lng;
