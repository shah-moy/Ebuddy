    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <div class="fs-5 mb-5">
                 <span id="price"><?php echo $inv[0]['price'] ?></span> TK
                <br>
                ...
                <p class="lead">
				<div class="text">
                            <a class="btn btn-outline-success btn-sm m-0"   href=".?p=shops&id=<?php echo md5($row['id']) ?>">View Shop</a>
                        </div>
                        
				<?php echo stripslashes(html_entity_decode($description)) ?></p>
