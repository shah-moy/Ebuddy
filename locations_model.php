...
function add_location(){
    $con=mysqli_connect ("localhost", 'root', '','e_buddy_5');
    if (!$con) {
    ...
    $query = sprintf("INSERT INTO locations " .
        " (id, shop_name, lat, lng, hour, description) " .
        " VALUES (NULL, '%s', '%s', '%s', '%s', '%s');",
        mysqli_real_escape_string($con,$shop_name),
...
select id ,shop_name,lat,lng,hour,description,location_status as isconfirmed
