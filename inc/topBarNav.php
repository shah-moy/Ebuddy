<nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-9 px-lg-9 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <a class="text-dark mr-2 nav-link" href="./?p=show_map">
                            <i class="bi-geo"></i>
                       
                          
                      <button class="btn btn-outline-success btn-sm m-0" type="submit" id="button-addon2"><i class="fa fa-street-view"></i>
                    ...
                    <div class="d-flex align-items-center">
                      <?php if(!isset($_SESSION['userdata']['id'])): ?>
                        ...
                        <a class="text-dark mr-2 nav-link" href="./?p=cart">
                            ...
                            <a href="logout.php" class="text-dark  nav-link">Log out     <i class="fa fa-sign-out-alt"></i></a>
                            <?php if($_settings->userdata('id')==6):?>
						         <a class="text-dark mr-2 nav-link" href="./?p=locateadmin">
                            <i class="bi-geo"></i>
                            
                          
                      <button class="btn btn-outline-success btn-sm m-0" type="submit" id="button-addon2"><i class="fa fa-map-marker-alt"></i>
                      ...
                      <i class="bi-geo"></i>
                        ...
                        <?php else: ?>
						         <a class="text-dark mr-2 nav-link" href="./?p=locate">
                            <i class="bi-geo"></i>
